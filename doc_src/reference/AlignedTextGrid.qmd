...
| Name | Description |
| --- | --- |
| [get_intervals_at_time](#aligned_textgrid.aligned_textgrid.AlignedTextGrid.get_intervals_at_time) | _Get interval indices at time_ |
| [return_textgrid](#aligned_textgrid.aligned_textgrid.AlignedTextGrid.return_textgrid) | _Convert this `AlignedTextGrid` to a `praatio` `Textgrid`_ |
| [save_textgrid](#aligned_textgrid.aligned_textgrid.AlignedTextGrid.save_textgrid) | _Saves the current AlignedTextGrid_ |
